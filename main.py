...
dataGen = ImageDataGenerator(width_shift_range=0.1,    # 0.1 = 10%
                             ...
                             zoom_range=0.2,  # 0.2 NGHĨA LÀ TỪ 0.8 TỚI 1.2
                             shear_range=0.1,  # KÍCH CỠ CỬA GÓC SHEAR
                             rotation_range=10)  # ĐỘ
dataGen.fit(X_train)
batches = dataGen.flow(X_train, y_train,batch_size=20)  # YÊU CẦU BỘ PHÁT DỮ LIỆU ĐỂ TẠO HÌNH ẢNH KÍCH THƯỚC = NO. CUẢ ẢNH ĐƯỢC TẠO SAU MỖI LẦN GỌI
